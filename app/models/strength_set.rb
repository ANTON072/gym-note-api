...
class StrengthSet < WorkoutSet
  ...
  def validate_reps_by_laterality
    ...
    if exercise.bilateral?
      ...
      errors.add(:reps, :greater_than_or_equal_to, count: 1) if reps.present? && reps < 1
      ...
      errors.add(:left_reps, :greater_than_or_equal_to, count: 0) if left_reps.present? && left_reps < 0
      errors.add(:right_reps, :greater_than_or_equal_to, count: 0) if right_reps.present? && right_reps < 0
